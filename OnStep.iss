...
#define MyAppName "OnStep mount X2 PlugIn"
#define MyAppVersion "1.150"
...
AppId={{A281547E-7B40-4440-8768-AE738155A018}
AppName={#MyAppName}
...
Source: "OnStep.png";                             DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
; 64 bits
...
Source: "OnStep.png";                             DestDir: "{app}\Plugins64\MountPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\MountPlugIns'))

...
#define MyAppName "Rainbow Astro OnStep mount X2 PlugIn"
...
AppId={{AC6AE96B-CC40-4E99-8689-68C0EC5E2AE1}
AppName={#MyAppName}
...
OutputBaseFilename=OnStep_X2_Installer
...
[Files]
Source: "mountlist OnStep.txt";                DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "mountlist OnStep.txt";                DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "mountlist64 OnStep.txt"
; 32 bits
Source: "libOnStep\Win32\Release\libOnStep.dll";  DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
Source: "OnStep.ui";                           DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
Source: "RainbowAstro.png";                 DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
; 64 bits
Source: "libOnStep\x64\Release\libOnStep.dll";    DestDir: "{app}\Plugins64\MountPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\MountPlugIns'))
Source: "OnStep.ui";                           DestDir: "{app}\Plugins64\MountPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\MountPlugIns'))
Source: "RainbowAstro.png";                 DestDir: "{app}\Plugins64\MountPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\MountPlugIns'))
